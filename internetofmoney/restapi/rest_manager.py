...
from internetofmoney.restapi.root_endpoint import RootEndpoint
...
class RESTManager(TaskManager):
    ...
    def start(self, port):
        ...
        Starts the HTTP API
        """
        self.root_endpoint = RootEndpoint(self.database, self.cache_dir, money_community=self.money_community)
