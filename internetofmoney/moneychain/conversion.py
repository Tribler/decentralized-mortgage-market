...
from internetofmoney.moneychain.block import TrustChainBlock, block_pack_size, PK_LENGTH, EMPTY_PK
...
class TrustChainConversion(BinaryConversion):
    ...
    def __init__(self, community):
        ...
        from internetofmoney.moneychain.community import HALF_BLOCK, CRAWL
